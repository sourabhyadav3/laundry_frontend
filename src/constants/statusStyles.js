...
export const TERMINAL_ORDER_STATUSES = ['Delivered', 'Return', 'Store', 'Store 1', 'Store 2'];
...
const pill = {
  ...
  ironing: 'status-pill bg-amber-500/10 text-amber-600 border-amber-500/15',
  washing: 'status-pill bg-cyan-500/10 text-cyan-600 border-cyan-500/15',
  hold: 'status-pill bg-rose-500/10 text-rose-600 border-rose-500/15',
  ...
  store1: 'status-pill bg-slate-500/10 text-slate-600 border-slate-500/15',
  store2: 'status-pill bg-zinc-500/10 text-zinc-600 border-zinc-500/15',
};
