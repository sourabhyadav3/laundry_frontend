              ...
              <div className="rounded-2xl border border-border bg-surface-alt/60 p-4 shadow-sm">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                  ...
                  <div className="rounded-xl border border-border bg-surface p-3 shadow-sm">
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-bold uppercase tracking-wider text-secondary">
                        {tr('Total Items Issued')}
                      </span>
                      <span className="text-sm select-none">📦</span>
                    </div>
                    <p className="mt-1.5 text-lg font-black text-primary">
                      {totalItemsIssued} <span className="text-xs font-semibold text-secondary">{tr('pcs')}</span>
                    </p>
                    <p className="text-[10px] text-secondary mt-0.5">
                      {customerOrders.length} {tr('total orders')}
                    </p>
                  </div>
                  ...
                  <div className="rounded-xl border border-border bg-surface p-3 shadow-sm">
                    ...
                    <p className="text-[10px] text-secondary mt-0.5">
                      {sixMonthItems} {tr('items processed')}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {customerOrders.length > 0 && (
                <div>
                  <h4 className="text-sm font-semibold uppercase tracking-wider text-secondary mb-3 border-b border-border pb-1">
                    {tr('Recent Orders & Invoices')} ({customerOrders.length})
                  </h4>
